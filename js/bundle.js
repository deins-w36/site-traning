...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _services_service_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/service.js */ "./js/services/service.js");
...
function cards() {
    ...
    (0,_services_service_js__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://localhost:3000/menu')
    .then(data => {
...
/* harmony import */ var _services_service_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/service.js */ "./js/services/service.js");
...
//Смотря в каком виде надо получить данные от старницы(JSON/formData) (урок 56) 
            ...
            (0,_services_service_js__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', JSON.stringify(object))
...
function timer(id, deadline) {
    ...
    function getTimeRemaining(endTime) {
        const t = Date.parse(endTime) - Date.parse(new Date()) - 10800000,
              days = Math.floor(t / (1000*60*60*24)),   //перевод из мл сек в дни
